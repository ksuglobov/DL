...
def train_model(net, data, epochs=10, n_seqs=10, n_steps=50, opt='Adam', lr=0.001, clip=5, val_frac=0.1, cuda=False, print_every=10, print_info=False, tqdm_print=True):
    ''' Training a network 
    ...
    for e in tqdm(range(epochs), disable=(not tqdm_print)):
